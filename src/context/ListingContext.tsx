...
import { useAuth } from "./AuthContext"; // Updated to use relative import since it's in the same directoryimport { supabase } from "../supabaseClient";
...
// Create context with a default valueconst ListingContext = createContext<ListingContextType | undefined>(undefined);
// Provider component
...
// Custom hook to use the contextexport const useListings = () => {
  const context = useContext(ListingContext);  if (context === undefined) {
